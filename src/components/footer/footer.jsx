...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto ">
      <div className="bg-gray-100 grid grid-cols-2 gap-4 px-8 py-6 lg:py-8 md:grid-cols-4">
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                    <a href="/carrier" className="hover:underline">Carrier</a>
                </li>
            </ul>
        </div>
        <div>
    ...
    <div className="px-4 py-6 bg-white shadow-lg md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="">Sahil Kadian</a>. All Rights Reserved.
        </span>
